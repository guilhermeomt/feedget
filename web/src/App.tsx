      ...
      <div className="flex-[66%] flex items-center justify-center">
        <div className="bg-[#181818] w-6/12 h-3/6 p-12 flex flex-col items-center rounded-lg">
          ...
          <main className="h-full flex justify-center">
            <button className="bg-brand-500 self-center text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center gap-1 hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500">
